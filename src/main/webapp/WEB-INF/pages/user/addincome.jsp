...
<html>
<head>
    <title>Add Income | MoneyHandler</title>
...
<main class="main-content">
    ...
    <form method="post" action="${contextPath}/user/income/add" class="income-form">
        <label>Amount:</label>
        ...
        <select name="incomeTypeId" required>
            ...
            <c:forEach var="type" items="${incomeTypes}">
                <option value="${type.typeId}">${type.typeName} (${type.source})</option>
            </c:forEach>
        </select>
