...
<html>
<head>
    <title>Add Expense | MoneyHandler</title>
...
<main>
    ...
    <form method="post" action="${contextPath}/user/add-expense" class="form-layout">
        <label>Amount:</label>
        ...
        <select name="expenseTypeId" required>
            ...
            <c:forEach var="type" items="${expenseTypeList}">
                <option value="${type.expenseTypeId}">${type.typeName} (${type.vendor})</option>
            </c:forEach>
        </select>
